...
export const BAITS_BY_CITY: Record<CityId, string[]> = {
  batumi: ['Микроджиг', 'Силикон', 'Блесна', 'Воблер', 'Креветка', 'Морской червь', 'Вертушка', 'Бомбарда', 'Пилькер', 'Булер', 'Мормышка', 'Мушка'],
  moscow: ['Микроджиг', 'Блесна', 'Воблер', 'Червь', 'Опарыш', 'Кукуруза', 'Мушка'],
}
