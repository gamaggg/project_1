...
// Embedded directly in ProfileScreen (not a standalone route) — signing in there
// updates AuthProvider's state, which the profile screen picks up reactively and
// swaps this form out for the real profile. See DECISIONS.md.
export function AuthForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // updates `user`, and ProfileScreen re-renders showing the real profile.
  }

  return (
    <div className="auth-card">
      <div className="page-title" style={{ textAlign: 'center', fontSize: 24, marginTop: 14 }}>
