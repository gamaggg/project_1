...
const data = JSON.parse(fs.readFileSync('/tmp/ckad-probe/mkad_ways.json', 'utf8'));
...
if (rings.length) {
  ...
  fs.writeFileSync('/tmp/ckad-probe/mkad_ring.geojson', JSON.stringify(turf.featureCollection([poly])));
}
