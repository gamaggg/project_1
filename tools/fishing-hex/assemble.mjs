...
//
// Вход:  hex.geojson, water.geojson (из build_hex.mjs)
...
const hex = fs.readFileSync('hex.geojson', 'utf8');
const water = fs.readFileSync('water.geojson', 'utf8');
...
console.log('map.html:', (html.length / 1024 / 1024).toFixed(2), 'MB', tiles === 'null' ? '(тайлы онлайн)' : '(тайлы вшиты)');
